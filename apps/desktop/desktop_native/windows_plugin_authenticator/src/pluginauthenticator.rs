...
impl EXPERIMENTAL_IPluginAuthenticator_Impl for PluginAuthenticatorComObject_Impl {
    unsafe fn EXPERIMENTAL_PluginMakeCredential(
        ...
        message(String::from("make credential hit"));
        panic!("make credential hit");
        HRESULT(0)
    }
    ...
    unsafe fn EXPERIMENTAL_PluginGetAssertion(
        ...
        message(String::from("get credential hit"));
        panic!("get credential hit");
        HRESULT(0)
    }
    ...
    unsafe fn EXPERIMENTAL_PluginCancelOperation(
        ...
        message(String::from("cancel credential hit"));
        panic!("cancel credential hit");
        HRESULT(0)
    }
}
