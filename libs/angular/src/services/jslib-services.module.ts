...
import { DefaultDecryptedVaultStateProvider } from "@bitwarden/common/vault/state/default-decrypted-vault-state-provider";
...
const safeProviders: SafeProvider[] = [
  ...
  safeProvider({
    ...
    useFactory: (
      ...
      vaultStateProvider: DecryptedVaultStateProvider,
    ) =>
      new CipherService(
        cryptoService,
        domainSettingsService,
  ...
  safeProvider({
    ...
    useClass: DefaultDecryptedVaultStateProvider,
    deps: [StateProvider],
  }),
  safeProvider({
