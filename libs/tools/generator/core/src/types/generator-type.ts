...
/** A type of ssh key that may be generated by the credential generator. */
export type SshKeyAlgorithm = (typeof SshKeyAlgorithms)[number];
...
export const CredentialCategories = Object.freeze({
  ...
  /** Lists algorithms in the "email" credential category */
  sshKey: SshKeyAlgorithms as Readonly<SshKeyAlgorithm[]>,
});
