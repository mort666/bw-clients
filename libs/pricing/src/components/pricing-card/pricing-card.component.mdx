...
| `disableVerticalPadding` | `boolean`                                                                                                        | **Optional.** Will not apply vertical padding styles when true. (Default: false)                                                                        |
| `disableCardBorder`      | `boolean`                                                                                                        | **Optional.** Will not apply card border styles when true. (Default: false)                                                                             |
